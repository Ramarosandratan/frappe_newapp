...
class AppAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    public function __construct(ErpNextService $erpNextService, UrlGeneratorInterface $urlGenerator)
    {
    ...
    {
        return new RedirectResponse($this->urlGenerator->generate('app_import'));
    }
